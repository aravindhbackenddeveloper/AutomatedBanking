...
<html>
   ...
   // accounts.getAccountList( RegisterData.getAccountApplication() );
    request.setAttribute("customerlist", accounts.accountList);
                        ...
                        <tbody>
                            <c:forEach items="${customerlist}" var="customer">
                                <tr>
                                    ...
                                    <td>
                                        <span class="list-username">${customer.customer.name}</span></td>
                                    <td></td>
                                    <td></td>
                                    <td><a class="btn btn-small"
                                           style="width: 50px; margin-bottom: 5px;"
                                           href="../../../approve_account?id=${customer.customer.customerId}">Approve</a><br />
                                    </td>
                                    <td>
                                           <a class="btn btn-small"
                                           style="width: 50px; margin-bottom: 5px;"
                                           href="../../../deny_account_request?id=${customer.customer.customerId}">Deny</a><br />
                                    </td>
                                    <td>
