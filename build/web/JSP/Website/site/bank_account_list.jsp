        ...
        <div id="page_container">
            ...
            <div id="body" class="container-fuid">
                ...
                <article id="content" class="span9">
                    ...
                    <h3>
                        Bank Account Information of ${cust.customerId} &nbsp;&nbsp;&nbsp;
                        <a href="account_edit.jsp?id=${cust.customerId}"
                            style="margin-top: 15px;" class="pull-right btn btn-small btn-info">Edit Details</a>
                             <br>
